...
const Reminder = () => {
    return (React.createElement("div", { className: "reminder" },
        ...
        React.createElement("span", { className: "reminder-text" },
            "",
            React.createElement("span", { className: "reminder-time" }, "notifications"))));
};
const Time = () => {
...
const Weather = () => {
    ...
    return (React.createElement(MenuSection, {id: "weather-section", scrollable: true, title: "Apps" }, getDays()));
};
const Tools = () => {
    const getTools = () => {
        return [].map((tool) => {
    ...
    return (React.createElement(MenuSection, {  id: "tools-section" }, getTools()));
};
const Restaurants = () => {
...
const Movies = () => {
    ...
    return (React.createElement(MenuSection, { id: "movies-section", scrollable: true }, getMovies()));
};
